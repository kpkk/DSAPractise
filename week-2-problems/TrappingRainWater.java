...
public class TrappingRainWater {
    ...
    public void test() {
        ...
        Assertions.assertEquals(6, trapWaterTwoPointer(heights));
    }

    @Test
    public void test1() {
        int[] heights = {4, 2, 0, 3, 2, 5};
        Assertions.assertEquals(9, trapWithTwoPointers(heights));
    }

    @Test
    public void test2() {
        int[] heights = {4, 2, 0, 3, 2, 1};
        Assertions.assertEquals(4, trapWithTwoPointers(heights));
    }
